...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <link href="${root}/css/fancybox/jquery.fancybox.css" rel="stylesheet">
  <link href="${root}/css/jcarousel.css" rel="stylesheet" />
  <link href="${root}/css/flexslider.css" rel="stylesheet" />
  <link href="${root}/css/style.css" rel="stylesheet" />
  
  <!-- Theme skin -->
  <link href="${root}/skinsjs/default.css" rel="stylesheet" />
    ...
    <header>
      <div class="container">
        ...
        <div class="row">
          <div class="span4">
            <div class="logo">
              <a href="index.html"><img src="${root}/img/logo.png" alt="" class="logo" /></a>
            ...
            <div class="navbar navbar-static-top">
              <div class="navigation">
                <nav>
                  <ul class="nav topnav">
                    <li class="dropdown">
                      <a href="${root}/pagemove/index.project">Home <i class="icon-angle-down"></i></a>
                    ...
                    <li class="dropdown">
                      <a href="#">스터디<i class="icon-angle-down"></i></a>
                      <ul class="dropdown-menu">
                        <li><a href="${root}/pagemove/studylist.project">방검색</a></li>
                        <li><a href="${root}/pagemove/studycreate.project">방생성</a></li>
                        <li><a href="${root}/pagemove/studycreate2.project">Blog right sidebar</a></li>
                        <li><a href="post-left-sidebar.html">Post left sidebar</a></li>
                        <li><a href="post-right-sidebar.html">Post right sidebar</a></li>
                      </ul>
                    </li>
                    <li>
                      <a href="${root}/pagemove/mypage.project">마이페이 </a>
                    </li>
                    <li>
